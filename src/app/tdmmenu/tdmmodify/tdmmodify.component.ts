...
@Component({
  selector: 'app-tdmmodify',
  templateUrl: './tdmmodify.component.html',
  styleUrls: ['./tdmmodify.component.css']
})
export class TdmmodifyComponent implements OnInit {

  CommonService: any;
  modifyterminal : FormGroup;
...
Defaulttrain:this.Defaulttrain
});
